        ...
        >
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                <a href="/forgot-password" class="font-medium text-indigo-600 hover:text-indigo-500" data-test-id="forgot-password-link">
            ...
            <div class="mt-6">
              <p class="text-center text-sm text-gray-600">
                ...
                <a href="/register" data-test-id="register-link" class="font-medium text-indigo-600 hover:text-indigo-500">
                  Sign up
                </a>
              </p>
            </div>
