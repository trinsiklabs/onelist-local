defmodule OnelistWeb.SessionManagementLive do
  ...
  def mount(_params, _session, socket) do
    if socket.assigns.current_user do
      ...
      current_session_id = case socket.assigns.current_session do
        %{id: id} -> id  # Regular session structure
        _ when is_map(socket.assigns.current_session) -> 
          ...
          if test_session && Map.has_key?(test_session, :id), do: test_session.id, else: "test-session-id"
        _ -> nil  # Fallback
      end
      ...
      <section class="sessions-list">
        ...
        >
          <div class="session-info">
            <div class="device">
              <span><%= device_icon(@current_session.device_name) %> <%= @current_session.device_name %></span>
