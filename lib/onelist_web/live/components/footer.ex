        ...
        <div class="xl:grid xl:grid-cols-4 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            ...
            <div class="flex space-x-6">
              ...
              <a
                href="https://twitter.com/onelist"
                data-test-id="social-twitter"
                class="text-gray-400 hover:text-gray-500"
              >
              ...
              <a
                href="https://linkedin.com/company/onelist"
                ...
                <form class="mt-4" data-test-id="newsletter-form">
                  <div class="flex">
                    ...
                    <div class="ml-3 rounded-md shadow">
                      <button
                        type="submit"
                        class="w-full flex items-center justify-center px-5 py-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      >
                        Subscribe
                      </button>
                    </div>
