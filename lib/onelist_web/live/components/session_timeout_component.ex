defmodule OnelistWeb.Components.SessionTimeoutComponent do
  ...
  def mount(socket) do
    {:ok, assign(socket,
      ...
      timeout_seconds: Application.get_env(:onelist, Onelist.Sessions)[:user_session_timeout] || 1800,
    ...
    >
      <div class="session-timeout-modal" data-test-id="session-timeout-modal" style="display: none;">
        <div class="modal-content">
          ...
          <p>Due to inactivity, your session will expire in <span id="timeout-countdown">0</span> seconds.</p>
