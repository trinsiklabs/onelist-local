defmodule OnelistWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: OnelistWeb.Gettext
  ...
  def input(%{field: %Phoenix.HTML.FormField{} = field} = assigns) do
    # Fix for Phoenix.Component.used_input?/1 warning
    # Instead of using Phoenix.Component.used_input?, we'll directly access field.errors
    # This is safe because we're already pattern matching on the field struct
    errors = field.errors
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OnelistWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OnelistWeb.Gettext, "errors", msg, opts)
    end
  end
