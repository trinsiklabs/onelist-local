defmodule Onelist.Workers.SessionCleanupWorker do
  ...
  defp cleanup_login_attempts do
    ...
    retention_days = Application.get_env(:onelist, Onelist.Accounts)[:login_attempt_retention_days] || 90
  ...
  defp schedule_cleanup do
    ...
    interval = Application.get_env(:onelist, Onelist.Sessions)[:cleanup_interval] ||
              @cleanup_interval
