defmodule Onelist.AccountsBehaviour do
  ...
  @callback create_social_account(user :: user(), params :: map()) ::
              {:ok, map()} | {:error, any()}
  @callback update_social_account(map(), String.t(), String.t(), map()) ::
              {:ok, map()} | {:error, atom()}
  ...
  @callback create_user_with_social_account(map(), String.t(), String.t()) ::
              {:ok, map()} | {:error, atom()}
